...
export default function CategoriesCreate() {
    ...
    return (
        <AdminLayout title="Add New Collection">
            <Head title="Add New Collection - Admin Panel" />
            
            <div className="space-y-6 pb-20">
                {/* Header Section */}
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-2xl font-k2d-bold text-gray-900">Add New Collection</h2>
                        <p className="mt-1 text-sm text-gray-600">
                            Create a new resin product collection
                        </p>
                    </div>
                    <Link
                ...
                <FormErrorSummary
                    ...
                    errors={errors}
                    actionText="create this collection"
                />
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">
                                        Auto-generated from name. URL: /collections/{data.slug || 'slug'}
                                    </p>
